...
src_prepare() {
	...
	eapply "${FILESDIR}"/${PV}/postrelease/64_pr88754.patch
	eapply "${FILESDIR}"/${PV}/postrelease/65_pr107482-109137.patch
	eapply "${FILESDIR}"/${PV}/postrelease/66_pr104637.patch
