...
src_prepare() {
	...
	eapply "${FILESDIR}"/${PV}/postrelease/218_pr117113.patch
	eapply "${FILESDIR}"/${PV}/postrelease/219_pr116850.patch
	eapply "${FILESDIR}"/${PV}/postrelease/220_pr79786.patch
	eapply "${FILESDIR}"/${PV}/postrelease/221_pr101533.patch
	eapply "${FILESDIR}"/${PV}/postrelease/222_pr117254.patch
	eapply "${FILESDIR}"/${PV}/postrelease/223_pr115646.patch
	eapply "${FILESDIR}"/${PV}/postrelease/224_pr117296.patch
	eapply "${FILESDIR}"/${PV}/postrelease/225_pr114292.patch
	...
	eapply "${FILESDIR}"/${PV}/postrelease/229_pr97714.patch
	eapply "${FILESDIR}"/${PV}/postrelease/230_pr83865.patch
	eapply "${FILESDIR}"/${PV}/postrelease/231_pr88440-90607.patch
	eapply "${FILESDIR}"/${PV}/postrelease/232_pr79855-80545-80645-85523-88554.patch
