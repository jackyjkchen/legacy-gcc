...
src_prepare() {
	...
	use test && [[ ${CTARGET} == arm*-*-*eabi ]] && eapply "${FILESDIR}"/${PV}/12_workaround-abi-warning-in-test.patch
	[[ $(tc-arch) == "arm" ]] && eapply "${FILESDIR}"/${PV}/13_gcc-arm.patch
	...
	eapply "${FILESDIR}"/${PV}/postrelease/103_pr26155.patch
	eapply "${FILESDIR}"/${PV}/postrelease/104_pr28501.patch
	eapply "${FILESDIR}"/${PV}/postrelease/105_pr29363.patch
	eapply "${FILESDIR}"/${PV}/postrelease/106_pr21659.patch
	eapply "${FILESDIR}"/${PV}/postrelease/107_pr20078.patch
	eapply "${FILESDIR}"/${PV}/postrelease/108_pr4784.patch
	eapply "${FILESDIR}"/${PV}/postrelease/109_pr41681-workaround.patch
	eapply "${FILESDIR}"/${PV}/postrelease/110_pr33763.patch
	eapply "${FILESDIR}"/${PV}/postrelease/111_pr38757.patch
	...
	eapply "${FILESDIR}"/${PV}/postrelease/119_pr54653.patch
	eapply "${FILESDIR}"/${PV}/postrelease/120_pr54858.patch
	eapply "${FILESDIR}"/${PV}/postrelease/121_pr56468.patch
	eapply "${FILESDIR}"/${PV}/postrelease/122_pr59224.patch
	eapply "${FILESDIR}"/${PV}/postrelease/123_pr50055.patch
	eapply "${FILESDIR}"/${PV}/postrelease/124_pr62174.patch
	eapply "${FILESDIR}"/${PV}/postrelease/125_pr64979.patch
	eapply "${FILESDIR}"/${PV}/postrelease/126_pr43390.patch
	eapply "${FILESDIR}"/${PV}/postrelease/127_pr46815.patch
	eapply "${FILESDIR}"/${PV}/postrelease/128_pr41063.patch
	eapply "${FILESDIR}"/${PV}/postrelease/129_pr40088.patch
