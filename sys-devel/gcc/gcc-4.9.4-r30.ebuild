...
src_prepare() {
	...
	eapply "${FILESDIR}"/${PV}/postrelease/185_pr84611.patch
	...
	eapply "${FILESDIR}"/${PV}/postrelease/190_pr79361.patch
	eapply "${FILESDIR}"/${PV}/postrelease/191_pr85061.patch
	eapply "${FILESDIR}"/${PV}/postrelease/192_pr77694.patch
	eapply "${FILESDIR}"/${PV}/postrelease/193_pr77791.patch
	eapply "${FILESDIR}"/${PV}/postrelease/194_pr69323.patch
	eapply "${FILESDIR}"/${PV}/postrelease/195_pr59746-66707.patch
	eapply "${FILESDIR}"/${PV}/postrelease/196_pr60226.patch
	eapply "${FILESDIR}"/${PV}/postrelease/197_pr58582.patch
	eapply "${FILESDIR}"/${PV}/postrelease/198_pr58614.patch
	eapply "${FILESDIR}"/${PV}/postrelease/199_pr60211.patch
	eapply "${FILESDIR}"/${PV}/postrelease/200_pr59120.patch
	eapply "${FILESDIR}"/${PV}/postrelease/201_pr61046.patch
	eapply "${FILESDIR}"/${PV}/postrelease/202_pr58612.patch
	eapply "${FILESDIR}"/${PV}/postrelease/203_pr58611.patch
	eapply "${FILESDIR}"/${PV}/postrelease/204_pr58511.patch
	eapply "${FILESDIR}"/${PV}/postrelease/205_pr58650.patch
	...
	eapply "${FILESDIR}"/${PV}/postrelease/211_pr80692.patch
	...
	eapply "${FILESDIR}"/${PV}/postrelease/227_pr66279.patch
	eapply "${FILESDIR}"/${PV}/postrelease/228_pr93672.patch
	eapply "${FILESDIR}"/${PV}/postrelease/229_pr115646.patch
	...
	eapply "${FILESDIR}"/${PV}/postrelease/238_pr64735.patch
	eapply "${FILESDIR}"/${PV}/postrelease/239_pr65618.patch
