...
src_prepare() {
	...
	eapply "${FILESDIR}"/${PV}/postrelease/65_pr100119.patch
	eapply "${FILESDIR}"/${PV}/postrelease/66_pr116512.patch
	eapply "${FILESDIR}"/${PV}/postrelease/67_pr81917.patch
	eapply "${FILESDIR}"/${PV}/postrelease/69_pr12672.patch
	eapply "${FILESDIR}"/${PV}/postrelease/70_pr69410.patch
	eapply "${FILESDIR}"/${PV}/postrelease/71_pr101869.patch
	eapply "${FILESDIR}"/${PV}/postrelease/72_pr67048.patch
	eapply "${FILESDIR}"/${PV}/postrelease/73_pr101087.patch
	eapply "${FILESDIR}"/${PV}/postrelease/74_pr82294-87436-93949.patch
	eapply "${FILESDIR}"/${PV}/postrelease/75_pr83913.patch
	eapply "${FILESDIR}"/${PV}/postrelease/76_pr80485.patch
	eapply "${FILESDIR}"/${PV}/postrelease/77_pr84988.patch
	eapply "${FILESDIR}"/${PV}/postrelease/78_pr94799.patch
	eapply "${FILESDIR}"/${PV}/postrelease/79_pr98016.patch
	eapply "${FILESDIR}"/${PV}/postrelease/80_pr81933.patch
	eapply "${FILESDIR}"/${PV}/postrelease/81_pr12333.patch
	eapply "${FILESDIR}"/${PV}/postrelease/82_pr93562.patch
	eapply "${FILESDIR}"/${PV}/postrelease/83_pr90951.patch
	eapply "${FILESDIR}"/${PV}/postrelease/84_pr90736.patch
	eapply "${FILESDIR}"/${PV}/postrelease/85_pr52625.patch
	eapply "${FILESDIR}"/${PV}/postrelease/86_pr87366.patch
	eapply "${FILESDIR}"/${PV}/postrelease/87_pr86986.patch
	eapply "${FILESDIR}"/${PV}/postrelease/88_pr82307.patch
	eapply "${FILESDIR}"/${PV}/postrelease/89_pr49070.patch
	eapply "${FILESDIR}"/${PV}/postrelease/90_pr81574.patch
	eapply "${FILESDIR}"/${PV}/postrelease/91_pr108550.patch
	eapply "${FILESDIR}"/${PV}/postrelease/92_pr71965.patch
	eapply "${FILESDIR}"/${PV}/postrelease/93_pr105774.patch
	eapply "${FILESDIR}"/${PV}/postrelease/94_pr63149.patch
	eapply "${FILESDIR}"/${PV}/postrelease/95_pr63797.patch
	eapply "${FILESDIR}"/${PV}/postrelease/96_pr90107.patch
	eapply "${FILESDIR}"/${PV}/postrelease/97_pr88754.patch
