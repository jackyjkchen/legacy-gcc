...
src_prepare() {
	...
	eapply "${FILESDIR}"/${PV}/postrelease/134_pr50055.patch
	eapply "${FILESDIR}"/${PV}/postrelease/135_pr46815.patch
	eapply "${FILESDIR}"/${PV}/postrelease/136_pr41063.patch
	eapply "${FILESDIR}"/${PV}/postrelease/137_pr40088.patch
	eapply "${FILESDIR}"/${PV}/postrelease/138_pr39563.patch
