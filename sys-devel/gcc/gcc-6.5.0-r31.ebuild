...
src_prepare() {
	...
	use_linaro || eapply "${FILESDIR}"/${PV}/postrelease/158_pr79195.patch
	...
	use_linaro || eapply "${FILESDIR}"/${PV}/postrelease/164_pr78382.patch
	eapply "${FILESDIR}"/${PV}/postrelease/165_pr77959.patch
	use_linaro || eapply "${FILESDIR}"/${PV}/postrelease/166_pr70904.patch
	...
	eapply "${FILESDIR}"/${PV}/postrelease/256_pr79786.patch
	eapply "${FILESDIR}"/${PV}/postrelease/257_pr115646.patch
	eapply "${FILESDIR}"/${PV}/postrelease/258_pr117296.patch
